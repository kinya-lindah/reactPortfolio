...
export default function NavBar({toggle }) {
  ...
  const homeOpen = useMatch("/reactPortfolio");
  ...
  return (
    <>
      <Nav scrollNav={scrollNav}>
        <NavBarContainer>
          <NavLogoWrapper>
          {homeOpen?  <NavLogoScroll to="top" smooth={true} duration={750} spy={true} exact='true' offset={-85}>Lindah</NavLogoScroll>:<NavLogo to="/reactPortfolio">Lindah</NavLogo>}
          </NavLogoWrapper>
